...
for q in tqdm.tqdm(ORDERS):
    ...
    for tol in tqdm.tqdm(TOLERANCES):
        ...
        # The preferable way is to solve the BVP with the bridge prior.
        # If that does not work, use a manual initial guess.
        # If that does not work either, set NaNs.
        try:
            ...
            chi2 = (
                    timeseries.anees(solution, reference_solution,
                                     testlocations)
                    / sigma_squared
            )
            ...
            try:
                ...
                initial_posterior, _ = solver.compute_initialisation(
                    bvp, initial_grid, initial_guess=initial_guess[0][:, None], use_bridge=True
                )
        ...
        error_scipy = timeseries.root_mean_square_error(scipy_sol_for_rmse, reference_solution, testlocations)
